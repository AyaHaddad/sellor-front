    ...
    <v-row>
      ...
      >
        <v-container class="fill-height pa-0" fluid>
          <v-img
            height="100%"
            lazy-src="https://images.unsplash.com/photo-1504716325983-cb91edab7e7d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
            src="https://images.unsplash.com/photo-1504716325983-cb91edab7e7d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
          ></v-img>
        </v-container>
      </v-col>
    </v-row>
